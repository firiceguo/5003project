...
if __name__ == '__main__':
    ...
    reviewpath = ['review','/Users/yanyunliu/Downloads/yelp_dataset_challenge_round9/yelp_academic_dataset_review.json']
    businesspath = ['business','/Users/yanyunliu/Downloads/yelp_dataset_challenge_round9/yelp_academic_dataset_business.json']
    checkinpath = ['checkin','/Users/yanyunliu/Downloads/yelp_dataset_challenge_round9/yelp_academic_dataset_checkin.json']
    userpath = ['user','/Users/yanyunliu/Downloads/yelp_dataset_challenge_round9/yelp_academic_dataset_user.json']
    tippath = ['tip','/Users/yanyunliu/Downloads/yelp_dataset_challenge_round9/yelp_academic_dataset_tip.json']
    ...
    for path_link in path_list:
        ...
        t1 = time.time()
        selectreviewDF = loadDataJson(path_link[0],'mongodb', path=path_link[1])
        t2 = time.time()
