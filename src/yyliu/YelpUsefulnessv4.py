...
def UsefulnessPredictionLDAWithoutCV(trainingdata,model):
    ...
    cv = CountVectorizer(inputCol="filtered_tokens_word", outputCol="raw_features", minDF=2.0, vocabSize = 250)
    idf = IDF(inputCol="raw_features", outputCol="features")
...
if __name__ == '__main__':
    ...
    t1 = time.time()
    selectreviewDF = loadDataJson('review', datafrom='json', path=reviewpath, Datalimit=True, DatalimitNum=500000)
